...
setcookie("entonox_date_from", $dateFrom);
...
setcookie("entonox_date_to", $dateTo);
...
<div>
    <form method="post">
        ...
        <a class="submit print" target="_blank" href="print_entonox.php">Print</a>
    </form>
</div>
