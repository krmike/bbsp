...
<form method="post"  enctype="multipart/form-data">
    <table class="table">
        <tr>
            ...
            <td>
                <input type="radio" id="trainingT" name="training_type" value="Training" />
                <label for="trainingT">Training</label> &nbsp;
                <input type="radio" id="trainingA" name="training_type" value="Assessment" />
                <label for="trainingA">Assessment</label>
            </td>
        </tr>
        <tr>
            <td class="right-cell">
