...
$(document).ready(function(){
    ...
    $('.training-title').click(function () {
        var title = $(this);
        var trainings = $(title).siblings('.training-category');
        $(trainings).slideToggle('slow');
    });
...
function saveIncident() {
    var form = $('#incident_form');
    var incident_id = $(form).data('id');
    $.post("/save_incident.php", {
            id: incident_id,
            incident_date_y: $('#incident_date_y').val(),
            incident_date_m: $('#incident_date_m').val(),
            incident_date_d: $('#incident_date_d').val(),
            first_name: $('#first_name').val(),
            last_name: $('#last_name').val(),
            dob_y: $('#dob_y').val(),
            dob_m: $('#dob_m').val(),
            dob_d: $('#dob_d').val(),
            incident_time_hours: $('#incident_time_hours').val(),
            incident_time_minutes: $('#incident_time_minutes').val(),
            patroller_arrival_time_hours: $('#patroller_arrival_time_hours').val(),
            patroller_arrival_time_minutes: $('#patroller_arrival_time_minutes').val(),
            mtbb_employee: $('#mtbb_employee').val(),
            employee_on_duty: $('#employee_on_duty').val(),
            gender: $('#gender').val(),
            street: $('#street').val(),
            city: $('#city').val(),
            state: $('#state').val(),
            ...
            last_meals: $('#last_meals').val(),
            last_bathroom: $('#last_bath').val(),
            history: $('#i_history').val(),
            description: $('#i_description').val(),
            helmet: $('#helmet_worn').val(),
            activity: $('#activity').val(),
            ability: $('#i_ability').val(),
            bindings_release: $('#i_bindings_release').val(),
            sb_stance: $('#i_sb_stance').val(),
            equipment_source: $('#equipment_source').val(),
            rental_source: $('#i_rental_source').val(),
            weather: $('#weather').val(),
            snow: $('#snow').val(),
            visibility: $('#visibility').val(),
            lift: $('#lift').val(),
            run: $('#run').val(),
            map_coordinates: $('#incident_coordinates').val(),
            symptoms: $('#symptoms').val(),
            spinal_injury: $('#spinal_injury').val(),
            spinal_comment: $('#i_spinal_comment').val(),
            loc: $('#loc').val(),
            loc_comment: $('#i_loc_comment').val(),
            transport: $('#transport').val(),
            penthrane: $('#penthrane').val(),
            '3ml_time_hours': $('#3ml_time_hours').val(),
            '3ml_time_minutes': $('#3ml_time_minutes').val(),
            '6ml_time_hours': $('#6ml_time_hours').val(),
            '6ml_time_minutes': $('#6ml_time_minutes').val(),
            witness: $('#witness').val(),
            witness_sec: $('#witnessSec').val(),
            entonox: $('#entonox').val(),
            entonox_start_time_hours: $('#entonox_start_time_hours').val(),
            entonox_start_time_minutes: $('#entonox_start_time_minutes').val(),
            entonox_start_amount: $('#entonox_start_amount').val(),
            entonox_end_amount: $('#entonox_end_amount').val(),
            oxygen: $('#oxygen').val(),
            oxygen_start_time_hours: $('#oxygen_start_time_hours').val(),
            oxygen_start_time_minutes: $('#oxygen_start_time_minutes').val(),
            oxygen_flow_rate: $('#oxygen_flow_rate').val(),
            treatment_provided: $('#treatment_provided').val(),
            recommended_advice: $('#recommended_advice').val(),
            dr: $('#dr').val(),
            referral_outcome: $('#referral_outcome').val(),
            ambulance_call_time_hours: $('#ambulance_call_time_hours').val(),
            ambulance_call_time_minutes: $('#ambulance_call_time_minutes').val(),
            ambulance_arrival_time_hours: $('#ambulance_arrival_time_hours').val(),
            ambulance_arrival_time_minutes: $('#ambulance_arrival_time_minutes').val(),
            ambulance_departure_time_hours: $('#ambulance_departure_time_hours').val(),
            ambulance_departure_time_minutes: $('#ambulance_departure_time_minutes').val(),
            ambulance_mode: $('#ambulance_mode').val(),
            ambulance_destination: $('#ambulance_destination').val(),
            additional_notes: $('#additional_notes').val(),
            signature_id: $('#patroller_signature').val(),

    },
        function(incident){
            if (incident != 'here') {
                $(form).data('id', incident);
            }
        }, "html");
}
...
var incident = {
    ...
    init: function(){
        ...
        $('.i_roles').change(function() {
            ...
            if (role_id == 1) {
                var tr = $(role).parents('tr');
                var patrollers_s = $(tr).find('.i_patrollers');
                $(patrollers_s).find('.ptrl-trainee').prop('disabled', 'disabled');
            } else {
                $('.ptrl-trainee').removeAttr('disabled');
            }
        });
        ...
        $('#add_patroller').click(function(){
            ...
            $('.i_roles').change(function(){
                ...
                if (role_id == 1) {
                    var tr = $(role).parents('tr');
                    var patrollers_s = $(tr).find('.i_patrollers');
                    $(patrollers_s).find('.ptrl-trainee').attr('disabled', 'disabled');
                } else {
                    $('.ptrl-trainee').removeAttr('disabled');
                }
                if ($(role).val() == "") {
