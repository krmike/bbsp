...
if ($_GET['id']) {
    $incidentData = $Incident->getById($_GET['id']);
}
...
if ($_POST['save']) {
    ...
    if ($_GET['id'] && $incidentData['incident_timestamp'] > date("Y-m-d H:i:s", time() - 172800)) {
        $Incident->updateById($_GET['id'], $aData);

        $SQL = "DELETE FROM incident_patrollers WHERE incident_id = ".$_GET['id']." ";
        ...
        $SQL = "DELETE FROM incident_phones WHERE incident_id = ".$_GET['id']." ";
        $result = $DB->sql_query($SQL);
        ...
        $SQL = "DELETE FROM incident_equipment WHERE incident_id = ".$_GET['id']." ";
        $result = $DB->sql_query($SQL);
        ...
        $equipmentLeft = $Incident->getIncidentLeftEquipment($_GET['id']);
        $oldEquip = array();
        $oldReady = array();
        ...
        $SQL = "DELETE FROM injures WHERE incident_id = ".$_GET['id']." ";
        $result = $DB->sql_query($SQL);
        ...
        $SQL = "DELETE FROM incident_vitails WHERE incident_id = ".$_GET['id']." ";
        $result = $DB->sql_query($SQL);
    ...
    if (!$_GET['id']) {
        ...
        if ($_POST['entonox'] == 1 && $_POST['witness'] > 0) {
            if (count($_POST['witness_signature']) > 0) {
                ...
                imagepng($img, 'signatures/ws_'.$incidentId.'.png');
        ...
        if ($_POST['entonox'] == 1 && $_POST['witness_sec'] > 0) {
            if (count($_POST['witness_sec_signature']) > 0) {
                ...
                imagepng($img, 'signatures/wss_'.$incidentId.'.png');
        ...
        if ($_POST['signature_id'] > 0) {
            if( $_POST['patroller_signature'] != "") {
                ...
                imagepng($img, 'signatures/ps_'.$incidentId.'.png');
        ...
        if ($_POST['dr'] > 0) {
            if (count($_POST['dr_signature']) > 0) {
                ...
                imagepng($img, 'signatures/drs_'.$incidentId.'.png');
        ...
        if ($_POST['c_signature'] != "") {
            ...
            imagepng($img, 'signatures/cs_'.$incidentId.'.png');
    ...
    if ($_GET['id']) {
        ...
        if ($_POST['entonox'] == 1 && $_POST['witness'] > 0 && $_POST['witness_signature'] && !file_exists("signatures/ws_".$_GET['id'].".png")) {
            if (count($_POST['witness_signature']) > 0) {
                $json = $_POST['witness_signature'];

                $img = sigJsonToImage($json);

                imagepng($img, 'signatures/ws_'.$_GET['id'].'.png');

                imagedestroy($img);
            }
        }

        if ($_POST['entonox'] == 1 && $_POST['witness_sec'] > 0 && $_POST['witness_sec_signature'] && !file_exists("signatures/wss_".$_GET['id'].".png")) {
            if (count($_POST['witness_sec_signature']) > 0) {
                $json = $_POST['witness_sec_signature'];

                $img = sigJsonToImage($json);

                imagepng($img, 'signatures/wss_'.$_GET['id'].'.png');

                imagedestroy($img);
            }
        }

        if ($_POST['dr'] > 0 && $_POST['dr_signature'] && !file_exists("signatures/drs_".$_GET['id'].".png") && $incidentData['dr_id'] < 1) {
            if (count($_POST['dr_signature']) > 0) {
            $json = $_POST['dr_signature'];

            $img = sigJsonToImage($json);

            imagepng($img, 'signatures/drs_' . $_GET['id'] . '.png');

            imagedestroy($img);
            }
        }

        if ($_POST['signature_id'] > 0 && $_POST['patroller_signature'] && !file_exists("signatures/ps_".$_GET['id'].".png")) {
            if ($_POST['patroller_signature'] != "") {
                $json = $_POST['patroller_signature'];

                $img = sigJsonToImage($json);

                imagepng($img, 'signatures/ps_'.$_GET['id'].'.png');

                imagedestroy($img);
            }
        }
        if ($_POST['c_signature'] != "" && !file_exists("signatures/cs_".$_GET['id'].".png")) {
            $json = $_POST['c_signature'];

            $img = sigJsonToImage($json);

            imagepng($img, 'signatures/cs_'.$_GET['id'].'.png');
...
<form method="post" enctype="multipart/form-data"
    ...
    if ($_GET['id']) {
        ?>
        <input type="hidden" id="incidentId" name="incidentId" value="<?=$_GET['id'];?>">
    <?
    }
    ?>
   <div id="tabs">
           ...
           <div class="incident-form">
               ...
               <div class="incident">
                   <div class="phones" id="phones">
                           <?
                           if($_GET['id']) {
                               $phones = $Incident->getIncidentPhones($_GET['id']);
           ...
           <div class="incident-form">
                   ...
                   <div class="input">
                       ...
                       <select id="incident_date_d" class="hours" name="incident_date_d">
                           ...
                           for ($i = 1; $i <= cal_days_in_month(CAL_GREGORIAN, date('m'), date('Y')); $i++) {
                               ...
                               <option value="<?=sprintf("%02d", $i);?>"
                                   <?
                                   if ($_GET['id'] && $date['2'] == sprintf("%02d", $i)) {
                                       ?>
                                       selected="selected"
                                   <?
                                   } else {
                                       if (!$_GET['id'] && date("d") == sprintf("%02d", $i)) {
                                           ?>
                                           selected="selected"
                                       <?
                                       }
                           ...
                           for ($i = 1; $i <= 12; $i++) {
                               ...
                               <option value="<?=sprintf("%02d", $i);?>"
                                   <?
                                   if ($_GET['id'] && $date['1'] == sprintf("%02d", $i)) {
                                       ?>
                                       selected="selected"
                                   <?
                                   } else {
                                       if (!$_GET['id'] && date("m") == sprintf("%02d", $i)) {
                                           ?>
                                           selected="selected"
                                       <?
                                       }
                           ...
                           for ($i = date("Y") - 90; $i <= date("Y") + 10; $i++) {
                               ...
                               <option value="<?=sprintf("%02d", $i);?>"
                                   <?
                                   if ($_GET['id'] && $date['0'] == sprintf("%02d", $i)) {
                                       ?>
                                       selected="selected"
                                   <?
                                   } else {
                                       if (!$_GET['id'] && date("Y") == sprintf("%02d", $i)) {
                                           ?>
                                           selected="selected"
                                       <?
                                       }
               ...
               <div class="incident">
                   ...
                   <div class="input">
                       ...
                       ?>
                       <select class="hours" name="incident_time_hours">
                           <?
                           for ($i = 0; $i < 24; $i++) {
                               ?>
                               <option value="<?=sprintf("%02d", $i);?>"
                                   <?
                                   if ($_GET['id'] && $time['0'] == sprintf("%02d", $i)) {
                                       ?>
                                       selected="selected"
                                   <?
                                   } else {
                                       if (!$_GET['id'] && date("H") == sprintf("%02d", $i)) {
                                           ?>
                                           selected="selected"
                                       <?
                                       }
                           ...
                           ?>
                       </select>:<select class="hours" name="incident_time_minutes">
                           <?
                           for ($i = 0; $i < 60; $i++) {
                               ?>
                               <option value="<?=sprintf("%02d", $i);?>"
                                   <?
                                   if ($_GET['id'] && $time['1'] == sprintf("%02d", $i)) {
                                       ?>
                                       selected="selected"
                                   <?
                                   } else {
                                       if (!$_GET['id'] && date("i") == sprintf("%02d", $i)) {
                                           ?>
                                           selected="selected"
                                       <?
                                       }
               ...
               <div class="incident">
                   ...
                   <div class="input">
                       ...
                       ?>
                       <select class="hours" name="patroller_arrival_time_hours">
                           <?
                           for ($i = 0; $i < 24; $i++) {
                               ?>
                               <option value="<?=sprintf("%02d", $i);?>"
                           ...
                           ?>
                       </select>:<select class="hours" name="patroller_arrival_time_minutes">
                           <?
                           for ($i = 0; $i < 60; $i++) {
                               ?>
                               <option value="<?=sprintf("%02d", $i);?>"
               ...
               <div class="incident">
                   ...
                   <div class="input  table-responsive">
                       <table class="table table-bordered" id="patrollers">
                           ...
                           <?
                           if ($_GET['id']) {
                               $ipatrollers = $Incident->getIncidentPatrollers($_GET['id']);
               ...
               <?
               if ($_GET['id']) {
                   $evidenceFiles = $Incident->getEvidence($_GET['id']);
                   ?>
                   <div>
                       <div class="incident">
                           <div class="label">
            ...
            <div class="incident-form">
                ...
                <div class="incident" id="3ml_time">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="3ml_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="3ml_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident" id="6ml_time">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="6ml_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="6ml_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident entonox">
                    ...
                    <div class="input">
                        ...
                        <?
                        if ($_GET['id'] && $incidentData['entonox'] == "1" && file_exists("signatures/ws_".$_GET['id'].".png")) {
                            ?>
                ...
                <div class="incident entonox">
                    ...
                    <div class="input">
                        ...
                        <?
                        if ($_GET['id'] && $incidentData['entonox'] == "1" && file_exists("signatures/wss_".$_GET['id'].".png")) {
                            ?>
                ...
                <div class="incident entonox">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="entonox_start_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="entonox_start_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident oxygen">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="oxygen_start_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="oxygen_start_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident">
                    ...
                    <div class="input">
                        <select id="incident-equipment" multiple="multiple" name="equipment[]">
                            <?
                            if ($_GET['id']) {
                                $equipmentAll = $Incident->getIncidentEquipment($_GET['id']);
                            }
                ...
                <div class="incident">
                    ...
                    <div class="input">
                        <?
                        if ($_GET['id']) {
                            $equipmentAll = $Incident->getIncidentLeftEquipment($_GET['id']);
                        }
                            ?>
                ...
                <div class="incident ambulance">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="ambulance_call_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="ambulance_call_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident ambulance">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="ambulance_arrival_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="ambulance_arrival_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident ambulance">
                    ...
                    <div class="input">
                        ...
                        ?>
                        <select class="hours" name="ambulance_departure_time_hours">
                            <?
                            for ($i = 0; $i < 24; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                            ...
                            ?>
                        </select>:<select class="hours" name="ambulance_departure_time_minutes">
                            <?
                            for ($i = 0; $i < 60; $i++) {
                                ?>
                                <option value="<?=sprintf("%02d", $i);?>"
                ...
                <div class="incident">
                    ...
                    <div class="input">
                        <textarea name="additional_notes"><?=$incidentData['additional_notes'];?></textarea>
                    </div>
                </div>
                <div class="incident">
                    ...
                    <div class="input">
                        ...
                        <?
                        if ($_GET['id'] && $incidentData['signature_id'] > 0 && file_exists("signatures/ps_".$_GET['id'].".png")) {
                            ?>
                ...
                <div class="incident">
                    ...
                    <div class="input">
                        ...
                        <?
                        if ($_GET['id'] && $incidentData['dr_id'] > 0 && file_exists("signatures/drs_".$_GET['id'].".png")) {
                            ?>
                ...
                <div class="incident">
                    ...
                    <div class="input" id="casualty">
                            <?
                            if ($_GET['id'] && $incidentData['unable_to_sign'] == 0 && file_exists("signatures/cs_".$_GET['id'].".png")) {
                                ?>
                        ...
                        ?>
                        <?
                        if ($_GET['id'] && $incidentData['unable_to_sign'] == 1) {
                            ?>
